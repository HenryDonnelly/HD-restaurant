        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.suppliers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <x-text-input type="text" name="phone_no" field="phone_no" placeholder="phone_no..."
                        class="w-full mt-6" :value="@old('phone_no')">
                    </x-text-input>

                    <x-primary-button class="mt-6">Save supplier</x-primary-button>
                </form>
            </div>
